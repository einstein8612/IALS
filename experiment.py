...
class Experiment(object):
    ...
    def evaluate(self, step, collect_data=False):
        ...
        print("MER {} at {}".format(np.mean(episode_rewards), step))
    ...
    def print_results(self, episode_return, episode_step, global_step, episode):
        ...
        """
        print(("Train step {} of {} ({:.2f}%)".format(global_step,
                                            self.parameters['total_steps'], global_step*100/float(self.parameters['total_steps']))))
        print(("-"*30))
